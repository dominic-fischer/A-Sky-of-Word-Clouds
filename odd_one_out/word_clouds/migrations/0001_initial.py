# Generated by Django 4.1.3 on 2025-07-08 11:10
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "lang_identifier",
                    models.CharField(
                        default="NA", max_length=3, primary_key=True, serialize=False
                    ),
                ),
                ("lang_name", models.CharField(default="NA", max_length=20)),
                ("proto_lang_fam", models.CharField(default="NA", max_length=20)),
                ("lang_fam", models.CharField(default="NA", max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name="Words",
