...
game mode: one cloud per meaning (game mode 1), or one cloud per language (game mode 2). In either case, three out of the four languages are always from the same language family, while one is not.  
...
![GameMode1_easy](./screenshots/Skyofwordclouds_percloud_easy.png)
...
![GameMode1_easy_result](./screenshots/Skyofwordclouds_percloud_easy_result.png)
...
![GameMode2](./screenshots/Skyofwordclouds_easy.png)

Analogously to game mode 1, the answer grid will be displayed upon submitting.

![GameMode2_easy_result](./screenshots/Skyofwordclouds_easy_result.png)
---
